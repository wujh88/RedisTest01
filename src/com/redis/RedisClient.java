...
public class RedisClient {
    ...
    public void show() {     
        ...
        SortedSetOperate();
        HashOperate(); 
        jedisPool.returnResourceObject(jedis);//.returnResource(jedis);//.returnResource(jedis);
        shardedJedisPool.returnResourceObject(shardedJedis);//.returnResource(shardedJedis);
    } 
